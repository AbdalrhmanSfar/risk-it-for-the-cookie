...
{
    public static MenuSFXScript instance;
    ...
    public void clickSFX()
    {
        ...
        MenuSFXScript.instance.PlaySFX(clickSound, transform, 1, Random.Range(0.8f, 1.2f));
    }

    public void boopSFX()
    {

        MenuSFXScript.instance.PlaySFX(boopSound, transform, 0.9f, Random.Range(0.8f, 1.2f));
    }
    public void slideSFX1()
    {
        float pitch;
        pitch = 1f + Masterslider.value;
        MenuSFXScript.instance.PlaySFX(boopSound, transform, 1, pitch);
    }
